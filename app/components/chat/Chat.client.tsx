...
export function Chat({ inRightPanel }: ChatFunctionProps) {
...
export const ChatImpl = memo(
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat, inRightPanel }: ChatProps) => {
    useShortcuts();
...
${prompt}`,
    ...
    const sendMessage = async (_event: React.UIEvent, messageInput?: string) => {
      ...
      if (selectedElement) {
        ...
        const elementInfo = `<div class=\"__mindvexSelectedElement__\" data-element='${JSON.stringify(selectedElement)}'>${JSON.stringify(`${selectedElement.displayText}`)}</div>`;
