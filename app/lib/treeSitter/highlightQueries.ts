...
export const HIGHLIGHT_QUERIES: Record<SupportedLanguage, string> = {
  ...
  php: '', ruby: '', swift: '', kotlin: '', dart: '', lua: '', shell: '',
  sql: '', xml: '', dockerfile: '', makefile: '', cmake: '', toml: '',
  ini: '', perl: '', r: '', julia: '', elixir: '', clojure: '', haskell: '',
  scala: '', erlang: '', fsharp: '', ocaml: '', scheme: '', lisp: '',
  fortran: '', matlab: '', vba: '', powershell: '', vim: '', latex: '',
  bibtex: '', graphql: '', proto: '', thrift: '', capnp: '', asn1: '',
  regex: '', diff: '', gitcommit: '', gitrebase: '', gitattributes: '',
  gitignore: '', dockerignore: '', editorconfig: '', eslintignore: '',
  prettierignore: '', npmignore: '', yarnignore: '', pnpmignore: '',
  bazel: '', buck: '', meson: '', ninja: '', gn: '', gnbuild: '',
  gnargs: '', starlark: ''
};
